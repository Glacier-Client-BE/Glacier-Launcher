...
public partial class Home
{
    private void BuildDefaultSearchResults()
    {
        _defaultSearchResults = new List<SearchResult>
        {
            ...
            new("fa-solid fa-door-closed", "Close After Launch", "Settings", "Close launcher after launch", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "close after"; StateHasChanged(); }),
            new("fa-solid fa-palette", "Accent Colour", "Settings", "Change highlight colour", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "accent"; StateHasChanged(); }),
            new("fa-solid fa-moon", "Theme Preset", "Settings", "Dark, light and colour themes", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "theme"; StateHasChanged(); }),
            ...
            new("fa-solid fa-memory", "Java RAM", "Settings", "Maximum Java memory allocation", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "ram"; StateHasChanged(); }),
            new("fa-solid fa-terminal", "JVM Arguments", "Settings", "Advanced Java flags", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "jvm"; StateHasChanged(); }),
            new("fa-solid fa-window-minimize", "Minimize to Tray", "Settings", "Send launcher to system tray", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "tray"; StateHasChanged(); }),
            new("fa-solid fa-trash", "Clear Recent History", "Settings", "Clear recently launched list", "", () => { CloseSearch(); ClearRecentHistory(); }),
            new("fa-solid fa-rotate", "Check for Updates", "Settings", "Check launcher and client updates", "", () => { CloseSearch(); OpenSettings(); settingsFilter = "update"; StateHasChanged(); }),
